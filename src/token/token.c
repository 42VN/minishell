...
/*   Updated: 2024/11/22 20:00:25 by ktieu            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	ft_token_post_check(t_shell *shell, char **line)
{
	...
	{
		shell->tokens->syntax_err = ERR_SYNTAX_BR;
		ft_token_syntax_err(shell, *line);
		return (0);
	}
	return (0);
...
int	tokenize(t_shell *shell, char *line)
{
	...
	if (ft_token_post_check(shell, &line) == 0)
		return (0);
