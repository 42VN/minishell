...
#    Updated: 2024/11/04 23:18:06 by hitran           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
AST_FILES			=	build_ast.c	read_heredoc.c #print_ast.c
...
EXEC_FILES			= 	execute_ast.c execute_cmd.c error.c find_cmd_path.c utils.c split_command.c split_utils.c
EXP_FILES			=	exp.c
